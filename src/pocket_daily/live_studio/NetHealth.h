...
// Device side. begin() installs the WiFi event hooks; the heartbeat task
// logs every 60 s. note() records one-off events (loop wifi-loss branch,
// send timeouts, abandon paths).
void begin();
